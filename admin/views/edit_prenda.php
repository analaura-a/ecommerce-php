...
<div class="row mb-5 d-flex align-items-center">
    ...
    <form class="row g-3" action="actions/add_prenda_action.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 col-6">
            ...
            <input type="text" class="form-control" id="nombre" name="nombre" value="<?= $prenda->getNombre() ?>" required>
        </div>
        ...
        <div class="mb-3 col-6">
            ...
            <select class="form-select" name="categoria" id="categoria" required>
                ...
                <?php foreach ($prenda->getCategoriasDisponibles() as $categoriaD) {  ?>
                    <option value="<?= $categoriaD ?>" <?= $categoriaD == $prenda->getCategoria() ? "selected" : "" ?>><?= $categoriaD ?></option>
                <?php } ?>
            </select>
        </div>
        ...
        <div class="mb-3 col-6">
            ...
            <input type="number" class="form-control" id="precio" name="precio" value="<?= $prenda->getPrecio() ?>" required>
        </div>

        <div class="mb-3 col-6">
            <label for="color" class="form-label">Color</label>
            <input type="text" class="form-control" id="color" name="color" value="<?= $prenda->getColor() ?>" required>
        </div>
        ...
        <div class="mb-3 col-6">
            ...
            <input type="text" class="form-control" id="publicacion" name="publicacion" value="<?= $prenda->getPublicacion() ?>" required>
